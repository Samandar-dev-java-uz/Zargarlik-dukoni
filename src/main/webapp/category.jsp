...
<head>
    ...
    <title>Kategoriya boshqaruvi</title>
...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item"><a class="nav-link active" href="/category"><i class="fas fa-tags"></i> Kategoriyalar</a></li>
...
<div class="main-content">
    <h2 class="mb-4"><i class="fas fa-tags me-2"></i>Kategoriya boshqaruvi</h2>

    <!-- Qo‘shish formasi -->
    <form action="/category" method="post" class="card p-4 shadow-sm mb-4">
        <div class="mb-3">
            <label for="categoryName" class="form-label">Kategoriya nomi</label>
            <input type="text" class="form-control" id="categoryName" name="name" required>
        </div>
        <button type="submit" class="btn btn-gold"><i class="fas fa-plus"></i> Qo‘shish</button>
    </form>

    <!-- Kategoriya ro‘yxati -->
    <div class="card p-4 shadow-sm">
        <h5>Kategoriyalar ro‘yxati</h5>
        <!-- Kategoriya ro‘yxati -->
        <div class="card p-4 shadow-sm">
            <h5>Kategoriyalar ro‘yxati</h5>
            <table class="table table-striped mt-3">
                ...
                <c:forEach var="category" items="${categories}" varStatus="loop">
                    <tr>
                        ...
                        <td>
                            <a href="/update-category?id=${category.id}" class="btn btn-warning btn-sm">
